 ...
 */
public class AdjustedSimilarityNonGapsScore implements Score
{
    ...
    public <S extends MSASolution> double compute(S solution, char[][] decodedSequences)
    {
        ...
        double similarityNG = (double) solution.getAttribute("similarityNG"); //solution.setAttribute("nonGapColumnCount", nonGapColumnCount);
        int nonGapColumnCount = (int) solution.getAttribute("nonGapColumnCount");
        solution.setAttribute("similarityNG",null);
        
        return similarityNG/nonGapColumnCount;
    }
    ...
    {
        return "Adjusted Similarity of non-gap columns in a multiple sequence";
    }
