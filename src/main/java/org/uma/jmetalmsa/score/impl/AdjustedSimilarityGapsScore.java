 ...
 */
public class AdjustedSimilarityGapsScore implements Score
{
    ...
    public <S extends MSASolution> double compute(S solution, char[][] decodedSequences)
    {
        ...
        return similarityG/GapIndexList.size();
    ...
    {
        return "Adjusted Similarity of gap columns in a multiple sequence";
    }
