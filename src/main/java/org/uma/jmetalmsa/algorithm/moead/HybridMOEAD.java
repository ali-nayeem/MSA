 ...
 * @author ali_nayeem
 */
public class HybridMOEAD extends MOEADMSA
{

    protected int div1, div2, runId;
    protected String initSolutionsRoot = "/Users/ali_nayeem/NetBeansProjects/Exp-MUSCLE/";
    ...
    protected void initializeUniformWeight()
    {
        ...
        populationSize = vg.getVectors().length;
...
//            try
//            {
//                List<ArrayChar> strAlignment = ((MSAProblem) problem).readDataFromFastaFile(initSolutionsRoot + "/msa" + population.size());
//                MSASolution s = new MSASolution(strAlignment, ((MSAProblem) problem));
//                population.add(s);
//            } catch (IOException ex)
//            {
//                Logger.getLogger(HybridMOEAD.class.getName()).log(Level.SEVERE, null, ex);
