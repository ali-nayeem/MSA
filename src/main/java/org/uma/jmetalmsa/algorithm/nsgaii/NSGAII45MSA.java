 ...
 * @version 1.0
 */
public class NSGAII45MSA extends NSGAII45<MSASolution> {
   ...
   * Constructor
   */
  public NSGAII45MSA(MSAProblem problem, int maxIterations, int populationSize,
  ...
  protected List<MSASolution> createInitialPopulation() {
    return ((MSAProblem) problem).createInitialPopulation(populationSize);
  }
